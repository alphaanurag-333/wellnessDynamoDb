/**
 * Migration 52: Web / App visibility flags for FAQ.
 *
 * Backfill `webVisible=true` and `appVisible=true` on existing
 * Faq rows so public listings stay unchanged until toggled off.
 */
...
async function migrateFaqVisibilityFlags() {
...
module.exports = {
  id: "52-faq-visibility-flags",
  migrateFaqVisibilityFlags,
};
