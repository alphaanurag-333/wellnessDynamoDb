/**
 * Migration 60: Web / App visibility flags for Health Disorders.
 *
 * Backfill `webVisible=true` and `appVisible=true` on existing
 * HealthDisorder rows so public listings stay unchanged until toggled off.
 */
...
async function migrateHealthDisorderVisibilityFlags() {
...
module.exports = {
  id: "60-health-disorder-visibility-flags",
  migrateHealthDisorderVisibilityFlags,
};
