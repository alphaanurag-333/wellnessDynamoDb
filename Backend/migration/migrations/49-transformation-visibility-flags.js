/**
 * Migration 49: Web / App visibility flags for Transformations.
 *
 * Backfill `webVisible=true` and `appVisible=true` on existing
 * Transformation rows so public listings stay unchanged until toggled off.
 */
...
async function migrateTransformationVisibilityFlags() {
...
module.exports = {
  id: "49-transformation-visibility-flags",
  migrateTransformationVisibilityFlags,
};
