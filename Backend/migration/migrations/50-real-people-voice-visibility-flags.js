/**
 * Migration 50: Web / App visibility flags for Real People + Voice testimonials.
 *
 * Backfill `webVisible=true` and `appVisible=true` on existing rows so public
 * listings stay unchanged until toggled off.
 */
const { UpdateCommand } = require("@aws-sdk/lib-dynamodb");
const { docClient } = require("../../config/db");
const { backupTable, scanTable, tableExists } = require("../lib/helpers");

const TABLES = ["RealPeopleTestimonial", "VideoTestimonials"];
...
async function migrateRealPeopleAndVoiceVisibilityFlags() {
...
module.exports = {
  id: "50-real-people-voice-visibility-flags",
  migrateRealPeopleAndVoiceVisibilityFlags,
};
