...
async function createRealPeopleTestimonialTable() {
  const params = {
  ...
  try {
    ...
    console.log("RealPeopleTestimonial table created:", result.TableDescription.TableArn);
  } catch (err) {
    if (err.name === "ResourceInUseException") {
      console.log("RealPeopleTestimonial table already exists");
    } else {
...
createRealPeopleTestimonialTable();
