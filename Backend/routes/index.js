...
router.use("/admin/blog-config", adminBlogConfigRoutes);
router.use("/admin/blog-posts", adminBlogPostRoutes);
router.use("/admin/blog-media", adminBlogMediaRoutes);
...
router.use("/admin/launch-config", adminLaunchConfigRoutes);
router.use("/admin/drf-config", adminDrfConfigRoutes);
...
router.use("/admin/diet-plan-book", adminDietPlanBookRoutes);
router.use("/admin/wellness-prescriptions", adminWellnessPrescriptionCatalogRoutes);
router.use("/admin/ai-enable", adminAiEnableRoutes);
