...
const adminChallengeRoutes = require("./adminRoutes/adminChallengeRoutes");
...
const wellnessYogaRoutes = require("./userRoutes/wellnessYogaRoutes");
...
const protocolSettingsRoutes = require("./userRoutes/protocolSettingsRoutes");
...
router.use("/admin/challenges", adminChallengeRoutes);
...
router.use("/admin/wellness-team-notes", adminWellnessTeamNoteRoutes);
...
router.use("/admin/referral-tree", adminReferralTreeRoutes);
...
router.use("/admin/wellness-yoga", adminWellnessYogaRoutes);
...
router.use("/user/challenges", require("./userRoutes/challengeRoutes"));
...
router.use("/user/wellness-yoga", wellnessYogaRoutes);
...
router.use("/user/protocol-settings", protocolSettingsRoutes);
