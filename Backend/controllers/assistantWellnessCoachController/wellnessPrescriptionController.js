...
exports.listAssistantUserWellnessPrescriptionsController = asyncHandler(async (req, res) => {
...
exports.createAssistantUserWellnessPrescriptionController = asyncHandler(async (req, res) => {
  const actingAssistantId = req.auth?.sub;
  if (!actingAssistantId) throw new AppError("Unauthorized", 401);
...
exports.deleteAssistantUserWellnessPrescriptionController = asyncHandler(async (req, res) => {
  const actingAssistantId = req.auth?.sub;
  if (!actingAssistantId) throw new AppError("Unauthorized", 401);
