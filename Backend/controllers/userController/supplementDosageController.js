...
const PERIOD_COLORS = {
  ...
  afternoon: "#1877F2",
  evening: "#7B61FF",
  before_1st_meal: "#F5A623",
  before_2nd_meal: "#1877F2",
  before_3rd_meal: "#7B61FF",
  before_4th_meal: "#7B61FF",
  after_1st_meal: "#F5A623",
  after_2nd_meal: "#1877F2",
  after_3rd_meal: "#7B61FF",
  after_4th_meal: "#7B61FF",
  empty_stomach_morning: "#F5A623",
  empty_stomach_evening: "#7B61FF",
  before_bed_30_mins: "#5B4B8A",
  after_morning_snacks: "#F5A623",
  before_morning_snacks: "#F5A623",
  after_evening_snacks: "#7B61FF",
  before_evening_snacks: "#7B61FF",
};
