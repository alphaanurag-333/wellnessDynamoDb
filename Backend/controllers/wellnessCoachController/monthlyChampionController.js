...
exports.listCoachMonthlyChampionPostsController = asyncHandler(async (req, res) => {
...
exports.getCoachMonthlyChampionPostByIdController = asyncHandler(async (req, res) => {
  const coachId = req.auth?.sub;
  if (!coachId) throw new AppError("Unauthorized", 401);
