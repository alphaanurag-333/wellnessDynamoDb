...
exports.getAdminUserDailyReflectionSettingsController = asyncHandler(async (req, res) => {
...
exports.getAdminUserDailyReflectionHistoryController = asyncHandler(async (req, res) => {
  const { userId } = await adminContext(req);
...
exports.updateAdminUserDailyReflectionSettingsController = asyncHandler(async (req, res) => {
  const { userId } = await adminContext(req);
