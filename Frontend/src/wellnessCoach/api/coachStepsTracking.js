...
export async function coachGetUserStepsTracking(token, userId, { days = 30, from, to } = {}) {
  ...
  try {
    const { data: body } = await coachApi.get(`${healUsersBase()}/${userId}/steps-tracking${suffix}`, {
