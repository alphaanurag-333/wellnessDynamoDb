  ...
  return (
    <section className="fat-loss-page">
      ...
      <section className="fat-hero">
        ...
        <div className="container">
          <div className="fat-hero-content">
            ...
            Our Gut Health program is designed to promote a healthy digestive system. With personalized nutrition plans, probiotics, and expert advice, we aim to improve digestion, boost immunity, and enhance overall well-being. Achieve optimal gut health and feel your best with our comprehensive approach.
            </p>
          </div>
        </div>
      ...
      <section className="fat-about">
        <div className="container">
    <p>7 in 10 urban Indians experience gut health issues (Source: Times of India)
<br/>
Healthy Gut Healthy You !!
<br/>
Gut , our second brain, is home to trillions of microorganisms and the imbalance in the gut microbiome contributes to the development of lifestyle diseases.
<br/>
<br/>
