...
function base() {
  return "/admin/prakruti-questions";
}

export async function adminListPrakrutiQuestions(token, { page = 1, limit = 50, status, search, category } = {}) {
...
export async function adminGetPrakrutiQuestionById(token, id) {
  try {
