...
import { formatDate } from "./PrakrutiQuestionShared.js";
...
export function PrakrutiQuestionView() {
  ...
  return (
    <div className="user-page">
      <AdminPageHeader
        title="Prakruti question"
        subtitle="View this Prakruti assessment question."
        onBack={() => navigate(-1)}
        actions={
