...
import {
  adminDeleteMonthlyChampionComment,
  adminGetMonthlyChampionById,
} from "../../api/monthlyChampions.js";
import { logout } from "../../../store/authSlice.js";
import { NotFoundPage } from "../NotFoundPage.jsx";
import { AdminPageHeader, AdminStatusBadge } from "../../components/AdminCrud.jsx";
import { formatDateTime, rankBadge } from "./MonthlyChampionShared.js";
...
export function MonthlyChampionView() {
  ...
  const onDeleteComment = async (comment) => {
    ...
    try {
      await adminDeleteMonthlyChampionComment(adminToken, postId, comment._id);
      await load();
    } catch (e) {
      if (e?.status === 401) return dispatch(logout());
