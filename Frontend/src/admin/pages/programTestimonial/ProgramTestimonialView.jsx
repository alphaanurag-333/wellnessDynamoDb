...
import { formatDateTime, typeLabel } from "./ProgramTestimonialShared.js";
...
export function ProgramTestimonialView() {
  ...
  return (
    <div className="user-page">
      <AdminPageHeader
        title="Program testimonial details"
        subtitle="View this program testimonial."
        onBack={() => navigate(-1)}
        actions={
