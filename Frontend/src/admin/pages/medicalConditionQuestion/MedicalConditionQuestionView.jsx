...
import { answerTypeLabel, formatDate } from "./MedicalConditionQuestionShared.js";
...
export function MedicalConditionQuestionView() {
  ...
  return (
    <div className="user-page">
      <AdminPageHeader
        title="Medical condition question"
        subtitle="View this onboarding question."
        onBack={() => navigate(-1)}
        actions={
      ...
      <div className="page-card user-view-card">
        <div className="user-view-grid">
          <DetailRow label="Answer type" value={answerTypeLabel(question.answerType)} />
          <div className="user-detail-row">
