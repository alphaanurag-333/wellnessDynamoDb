    ...
    <form onSubmit={onSubmit}>
      <div className="row g-3">
        ...
        <div className="user-field col-12 col-md-6">
          <AdminImagePicker
            label="Product image"
            hint="Square product photo. Crop to 400 × 400px after selecting."
            required={!editId}
            optionalLabel={Boolean(editId)}
            outputWidth={ADMIN_IMAGE_PRESETS.product.width}
            outputHeight={ADMIN_IMAGE_PRESETS.product.height}
            previewMaxWidth={ADMIN_IMAGE_PRESETS.product.previewMaxWidth}
            cropTitle="Crop product image"
            file={imageFile}
