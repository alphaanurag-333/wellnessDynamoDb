...
import { formatDate, truncate, TITLE_PREVIEW_LEN, LIST_LIMIT, LIST_SEARCH_MAX_LEN } from "./PrakrutiThingToAvoidShared.js";
      ...
      <div className="page-card">
        ...
        <div className="table-scroll">
          <table className="data-table">
            ...
            <tbody>
              {loading ? (
                <AdminTableLoaderRow colSpan={5} label="Loading…" />
              ) : rows.length === 0 ? (
                <tr>
