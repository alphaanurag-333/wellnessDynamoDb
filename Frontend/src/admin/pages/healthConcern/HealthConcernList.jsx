...
export function HealthConcernList() {
  ...
  const { canEdit, canDelete } = useResourcePermissions("health-concerns");
  ...
  const subtitle = listCountSubtitle(loading, total, "health concern", "health concerns");
    ...
    <div className="user-page">
      <div className="page-card">
        <AdminListHeader
          ...
          actions={
            canEdit ? (
            <button type="button" className="btn btn--primary" onClick={() => navigate("/admin/health-concerns/new")}>
              Add health concern
            </button>
          ) : null
          }
        ...
        <div className="table-scroll">
          <table className="data-table">
            ...
            <tbody>
              {loading ? (
                <AdminTableLoaderRow colSpan={7} label="Loading health concerns..." />
              ) : rows.length === 0 ? (
                <tr>
...
<button
                    ...
                    <td>
                      <div className="row-actions">
                        <Link to={`/admin/health-concerns/${row._id}`} className="icon-btn icon-btn--view" title="View">
...
<button
                          ...
                          title="Edit"
                          onClick={() => navigate(`/admin/health-concerns/${row._id}/edit`)}
                        >
