...
const PIE_COLORS = ["#10b981", "#2563eb", "#f59e0b", "#a855f7", "#6366f1"];
...
export function AssistantDashboardCharts({ charts }) {
    ...
    <section className="admin-dashboard-charts" aria-label="Dashboard charts">
      <div className="admin-dashboard-charts__grid">
        <ChartPanel
          ...
          subtitle="Heal vs consultancy clients under your care"
          empty={!hasClients}
        >
        ...
        <ChartPanel title="Clients by tier" subtitle="Your assigned client mix" empty={!hasTiers}>
