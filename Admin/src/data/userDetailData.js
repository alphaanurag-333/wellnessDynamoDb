...
function emptyProfileExtras(goal = "") {
  return {
    ...
    presentablePicHistory: [],
    presentablePicsEnabled: true,
...
export function profileFromListUser(row, userId) {
  ...
  return {
    ...
    presentablePicStatus: base.presentablePicStatus || extra.presentablePicStatus || "",
    presentablePicUploadedAt: base.presentablePicUploadedAt || extra.presentablePicUploadedAt || "",
    presentablePicHistory: base.presentablePicHistory || extra.presentablePicHistory || [],
    presentablePicsEnabled: base.presentablePicsEnabled !== false,
    dietPlanEnabled: base.dietPlanEnabled !== false,
    heartRateEnabled: base.heartRateEnabled !== false,
    sleepTrackingEnabled: base.sleepTrackingEnabled !== false,
    referralCode: base.referralCode || extra.referralCode,
    referredByCode: base.referredByCode || extra.referredByCode || "",
