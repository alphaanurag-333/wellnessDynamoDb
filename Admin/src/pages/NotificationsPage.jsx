...
const KIND_LABELS = {
  ...
  counselling_requested: "Counselling",
  counselling_period_selected: "Counselling",
  counselling_time_requested: "Counselling",
  counselling_cancelled: "Counselling",
...
function kindColor(kindKey) {
  ...
  const map = {
    ...
    counselling: { color: "#ec7a45", bg: "#fff9f4" },
