...
export function ConfigDetailPage() {
  ...
  function renderBody() {
    switch (item.id) {
      ...
      case "app-challenges":
        return <ChallengesSection onToast={onToast} />;
      case "app-coupons":
        return <CouponsSection onToast={onToast} />;
      case "app-rx-bank":
        return (
          <RxBankSection
